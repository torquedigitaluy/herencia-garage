  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden pt-16">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 65% 40%, rgba(245,181,10,0.08), transparent 55%)",
        }}
      />
      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-12 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          ...
          <h1 className="mt-6 font-display text-6xl font-bold uppercase leading-[0.92] tracking-tight sm:text-7xl lg:text-8xl">
            Herencia
            <br />
            <span className="text-amarillo">Garage</span>
          </h1>

          <p className="mt-8 max-w-md text-lg leading-relaxed text-metal">
            Taller especializado en chapa y pintura de autos clásicos.
            Rescatamos carrocerías del óxido y las devolvemos a su color
            original, panel por panel, con la paciencia del oficio y acabados
            de primer nivel.
          </p>
      ...
      <div className="absolute inset-x-0 bottom-8 flex justify-center">
        <span className="flex items-center gap-2 font-display text-xs uppercase tracking-[0.3em] text-metal">
          <ArrowDown className="h-4 w-4 animate-bounce text-amarillo" strokeWidth={1.5} />
